...
class ObjectBoxSchemaGuard {
  ...
  static String _currentSchemaSignature() {
    ...
    return [
      ...
      'PeakList.region:${_hasProperty(peakList, 'region')}',
      'PeakList.colour:${_hasProperty(peakList, 'colour')}',
      'PeakList.peakList:${_hasProperty(peakList, 'peakList')}',
      'PeakList.membershipState:${_hasProperty(peakList, 'membershipState')}',
      'PeakList.minLat:${_hasProperty(peakList, 'minLat')}',
      'PeakList.maxLat:${_hasProperty(peakList, 'maxLat')}',
      'PeakList.minLng:${_hasProperty(peakList, 'minLng')}',
      'PeakList.maxLng:${_hasProperty(peakList, 'maxLng')}',

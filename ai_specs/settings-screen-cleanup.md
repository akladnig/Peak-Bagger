<goal>
Refactor `./lib/screens/settings_screen.dart` into smaller, cohesive screen-scoped files without changing route behavior, widget keys, or user-visible interactions.

...
void main() {
  testWidgets('export peak lists journey keeps progress across shell navigation', (
    tester,
  ) async {
  ...
  testWidgets('export peak lists warning path keeps completed warning details', (
    tester,
  ) async {
    final repository = await TestTasmapRepository.create();
    final robot = PeakListExportRobot(
